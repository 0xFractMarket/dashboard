            ...
            <div className="layout-specing">
                <div className="md:flex justify-between items-center">
                    ...
                    <ul className="tracking-[0.5px] inline-block sm:mt-0 mt-3">
                        <li className="inline-block capitalize text-[16px] font-medium duration-500 dark:text-white/70 hover:text-green-600 dark:hover:text-white"><a href="index.html">FractMarket</a></li>
                                ...
                                <div className="picture-item p-3" key={index}>
                                    <div className="bg-white dark:bg-slate-900 rounded-lg shadow dark:shadow-gray-800 p-6">
                                        <div className="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                            ...
                                            <div className="ps-4">
                                                <Link to="" className="text-lg hover:text-green-600 duration-500 ease-in-out">{item.name}</Link>
