                        ...
                        <div className="lg:w-2/5">
                            <div className="relative overflow-hidden rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800">
                                ...
                                <div className="px-6 py-12 text-center">
                                    ...
                                    <div className="mt-6">
                                        <Link to="/" className="btn bg-green-600 hover:bg-green-700 border-green-600 hover:border-greenbg-green-700 text-white rounded-md">Continue</Link>
                                    </div>
                                </div>

                                <div className="text-center p-6 border-t border-gray-100 dark:border-gray-700">
                                    <p className="mb-0 text-slate-400 font-medium">© {new Date().getFullYear()} FractMarket.</p>
                                </div>
                            </div>
                        </div>
                    </div>
