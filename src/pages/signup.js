                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1">
                    <div className="relative overflow-hidden bg-white dark:bg-slate-900 shadow-md dark:shadow-gray-800 rounded-md">
                            ...
                            <form className="text-start">
                                <div className="grid grid-cols-1">
                                    ...
                                    <div className="text-center">
                                        <span className="text-slate-400 me-2">Already have an account ? </span> <Link to="/login" className="text-black dark:text-white font-medium">Sign in</Link>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div className="px-6 py-2 bg-slate-50 dark:bg-slate-800 text-center">
                            <p className="mb-0 text-slate-400">© {new Date().getFullYear()} FractMarket.</p>
                        </div>
                    </div>
                </div>
            </div>
